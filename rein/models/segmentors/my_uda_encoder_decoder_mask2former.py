...
class MyUDAEncoderDecoderMask2Former(EncoderDecoder):
    def __init__(self,
                 backbone: ConfigType,
    ...
    def encode_decode(self, inputs: Tensor,
        ...
        if is_pseudo:
            ...
            mask_pred = F.interpolate(
                ...
                mode='bilinear',
                align_corners=False)   # [1, 100, 512, 512]
            mask_pred = mask_pred.sigmoid()
            cls_score = F.softmax(mask_cls_results, dim=-1)[..., :-1]  # [1, 100, 19]
            seg_logits = torch.einsum('bqc, bqhw->bchw', cls_score, mask_pred)   # [1, 19, 512, 512]
            return seg_logits
        else:
            img_shape = img_metas[0]['img_shape']
