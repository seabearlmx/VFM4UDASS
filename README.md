...
```
PORT=12345 CUDA_VISIBLE_DEVICES=1,2 bash tools/dist_train.sh configs/frozen_vfms/uda/uda_dinov2-L_hrda.py NUM_GPUS
PORT=12345 CUDA_VISIBLE_DEVICES=1,2 bash tools/dist_train.sh configs/frozen_vfms/uda/uda_eva02-L_hrda.py NUM_GPUS
PORT=12345 CUDA_VISIBLE_DEVICES=1,2 bash tools/dist_train.sh configs/frozen_vfms/uda/uda_sam-H_hrda.py NUM_GPUS
```
